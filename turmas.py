...
class AllTurmas():
	...
	def create(self, alunos_turma, modulo, turno, data_inicial, data_final, id_polos):
		nova_turma = Turma()
	...
	def update(self, id_turmas, alunos_turma, modulo, turno, data_inicial, data_final, id_polos):
		try:
